...
const switchRoute = require('../../middlewares/switch').switchRoute('offices');
const validate = require('../../middlewares/validate');
const { getValidation, deleteValidation, createValidation, updateValidation } = require('../../validations/util.validation');
