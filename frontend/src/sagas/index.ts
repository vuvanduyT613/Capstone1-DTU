...
import { getByIdUtil, updateById, deleteById, adminStatus, chartJS, updateByIdUser } from './util';
...
function* rootSaga() {
  yield all([
    ...
    takeLeading('UPDATE_PERSONAL', updateByIdUser),
    takeLeading('GET_ALL_APPOINTMENT_DOCTOR_API', getAllAppointmentDoctor),
  ]);
}
